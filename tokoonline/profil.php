...
<html lang="en">
  ...
  <body>
      ...
      <form class="form-container" action="" method="POST">
        <h3 class="mb-4 mt-5">Profil</h3>
        <div class="mb-2">
          <label for="exampleInputEmail1" class="form-label texs-form">Username</label>
        ...
        <div class="mb-2">
          ...
          <div class="garis-judul"></div>
          <h3 class="text-end">
              <?php echo $d->admin_address ?>
          </h3>
        </div>
        <div class="row">
          <div class="col d-grid mt-5">
              <a href="home-c.php" class="btn btn-outline-info texs-form" >Beralih ke Mode Costemer</a>
              
          </div>
          <div class="col d-grid mt-5">
              <a href="edit-profil.php" class="btn btn-outline-primary texs-form" >Edit Data Profil</a>

          </div>
        </div>
        
        <div class="d-grid mt-3">
            <a href="out.php" class="btn btn-outline-danger texs-form">Logout</a>
        </div>
